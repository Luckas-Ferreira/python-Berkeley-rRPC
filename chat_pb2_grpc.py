...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SyncTime = channel.unary_unary(
                '/grpc.ChatServer/SyncTime',
                request_serializer=chat__pb2.TimeRequest.SerializeToString,
                response_deserializer=chat__pb2.TimeResponse.FromString,
                )
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SyncTime': grpc.unary_unary_rpc_method_handler(
                    servicer.SyncTime,
                    request_deserializer=chat__pb2.TimeRequest.FromString,
                    response_serializer=chat__pb2.TimeResponse.SerializeToString,
            ),
    }
...
class ChatServer(object):
    ...
    def SyncTime(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.ChatServer/SyncTime',
            chat__pb2.TimeRequest.SerializeToString,
            chat__pb2.TimeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
